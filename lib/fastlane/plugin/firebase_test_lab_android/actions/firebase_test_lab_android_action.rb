    ...
    class FirebaseTestLabAndroidAction < Action
      ...
      def self.run(params)
        ...
        Action.sh("set +e;"\
                  ...
                  "--type #{params[:type]} "\
                  "--app #{params[:app_apk]} "\
                  "#{"--test #{params[:app_test_apk]} " if !params[:app_test_apk].nil?}"\
      ...
      def self.example_code
        [
            ...
            app_apk: "mobile/build/outputs/apk/develop/release/mobile-develop-release.apk",
